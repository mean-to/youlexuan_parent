...
<title>发信息</title>
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				url:'${pageContext.request.contextPath}/us/getUnselfEmps',
				type:'post',
				dataType:'json',
				success:function (data) {
					$.each(data,function (index,emp) {
						$("#recvp").append("<option value='"+emp.eid+"'>"+emp.ename+"</option>");
					})
				}
			})
		})
...
<form name="form2" id="form12" action="${pageContext.request.contextPath}/us/saveMsg" method="post">
