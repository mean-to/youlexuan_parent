...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<c:if test="${flag==0}">
	<td>
		<a href="${pageContext.request.contextPath}/us/getBxById?bxid=${bs.bxid}">审批</a>
	</td>
	</c:if>
</tr>
</c:forEach>
...
<tr bgcolor="#FAFAF1">
		<td height="28" colspan="12">
			<a href="${pageContext.request.contextPath}/us/getbxtasks?flag=1" class="coolbg">&nbsp;已审批的报销&nbsp;</a>
		</td>
	</tr>
