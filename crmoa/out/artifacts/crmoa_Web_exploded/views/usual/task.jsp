...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/us/getTlist' method='post'>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center">
        <c:if test="${t.status==0}">未开始</c:if>
        <c:if test="${t.status==1}">进行中</c:if>
	...
	<td>2015-02-15</td>
	<td>
        <a href="${pageContext.request.contextPath}/us/getTaskById?tid=${t.id}">编辑</a> |
        <a href="task-look.jsp">查看详情</a>
    </td>
</tr>
</c:forEach>
...
<td height="28" colspan="12">
	&nbsp;
	<a href="${pageContext.request.contextPath}/us/getTlist?st=1" class="coolbg">未完成的任务</a>
	<a href="${pageContext.request.contextPath}/us/getTlist?st=2" class="coolbg">已完成的任务</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="${pageContext.request.contextPath}/us/getTlist?st=0" class="coolbg">未开始的任务</a>
