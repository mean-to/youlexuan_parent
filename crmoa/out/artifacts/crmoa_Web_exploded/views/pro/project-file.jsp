...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/views/pro/project-file-add.jsp';" value='添加新附件' />
 </td>
 </tr>
</table>
</td>
...
<!--  内容列表   -->
<form name="form2" id="conform" action="${pageContext.request.contextPath}/pro/delfile" method="post">
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>
        <fmt:formatDate value="${att.updatetime}" pattern="yyyy-MM-dd"></fmt:formatDate>
    </td>
	<td>
        <a href="${pageContext.request.contextPath}/pro/download?path=${att.path}">下载</a> |
        <a href="#">删除</a> |
        <a href="${pageContext.request.contextPath}/pro/getAttById?aid=${att.id}">编辑</a> |
        <a href="project-file-look.jsp">查看详情</a>
    </td>
</tr>
</c:forEach>
...
<td height="28" colspan="12">
	...
	<a href="javascript:delfile()" class="coolbg">&nbsp;删除&nbsp;</a>
