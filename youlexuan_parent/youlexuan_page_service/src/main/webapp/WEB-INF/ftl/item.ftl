					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl >
								...
								<#list spec.attributeValue as att>
								<dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${att}')" class="{{isSelected('${spec.attributeName}','${att}')?'selected':''}}">${att}<span title="点击取消选择">&nbsp;</span>
</a></dd></#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<button ng-click="addToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</button>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list  customAttributeList as att>
									<li>${att.text}：${att.value})</li>
									</#list>
								</ul>
