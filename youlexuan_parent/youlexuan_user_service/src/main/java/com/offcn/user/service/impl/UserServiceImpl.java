...
public class UserServiceImpl implements UserService {
	...
	public void CreateSmsCode(final String mobile) {
		...
		jmsTemplate.send(queueSmsDestination, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				mapMessage.setString("signName","优乐选电商平台");
				mapMessage.setString("templateCode","SMS_184626465");
    ...
    public boolean checkSmsCode(String mobile,String smsCode) {
	    String smsCode1 = (String)redisTemplate.boundHashOps("smsCode").get(mobile);
        if(smsCode1==null){
            return  false;
        }
